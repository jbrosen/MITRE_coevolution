...
//    field added by jbrosen, 1/15/2014
	...
	/**
	 * Overload setFitness to allow the setting of the first fitness value
	 * if fitnesses is empty, then create a fitness with key "default"
	...
	public void setFitness(Double d) {
		...
		if (keyIter.hasNext()) {
			this.setFitness((String)keyIter.next(), d);
		}
		else {
			this.setFitness("default",d);
		}
	}

...
public class RuleTreeMenuManager {
    ...
    public void printUsage(){
        ...
        System.err.println("java -jar ruletree.jar -predictions path_to_data -conditions path_to_conditions -model path_to_model -o path_to_predictions");
        System.err.println();
        System.err.println("TEST:");
        System.err.println("java -jar ruletree.jar -test path_to_data -conditions path_to_conditions");
        System.err.println();
    }
    ...
    //java -jar ruletree.jar -predictions path_to_data -conditions path_to_conditions -model path_to_model -o filename
    public void parseRuleTreePredictions(String args[]) throws IOException, ClassNotFoundException{
        String dataPath, popPath, conditionsPath,predPath;
        if (args.length==8){
            // by default integer targets = false
            dataPath = args[1];
            if(args[2].equals("-conditions")){
                conditionsPath = args[3];
                if(args[4].equals("-model")){
                    popPath = args[5];
                    if(args[6].equals("-o")){
                        predPath = args[7];
    ...
    public static void main(String args[]) throws IOException, ClassNotFoundException{
        ...
        if (args.length == 0) {
            ...
            }else if(args[0].equals("-predictions")){

...
public final class Parameters {
    ...
    public final static class Names {
        ...
        public static final String FALSE_POSITIVE_WEIGHT = "false_positive_weight";
    ...
    public final static class Operators {
        ...
        // Symbolic Regression-based Classification
        public static final String SR_CPP_ROC = "fitness.SRFitness.CppROC";
        public static final String SR_CUDA_ROC = "fitness.SRFitness.CudaROC";
        public static final String SR_CPP_ROC_CV = "fitness.SRFitness.CppROCCV";
        public static final String SR_CUDA_ROC_CV = "fitness.SRFitness.CudaROCCV";
        public static final String SR_CUDA_PRED = "fitness.SRFitness.CudaPred";

        // TREE-BASED RULE CLASSIFIER
        public static final String RBC_JAVA_FITNESS = "fitness.TBRCFitness.Java";
    ...
    public final static class Defaults {
        ...
        public static final double FALSE_POSITIVE_WEIGHT = 0.5;
        ...
        public static final List<String> UNARY_FUNCTIONS;
        static {
                UNARY_FUNCTIONS = new ArrayList<String>();
                
                UNARY_FUNCTIONS.add("mylog");
                UNARY_FUNCTIONS.add("exp");
                UNARY_FUNCTIONS.add("sin");
                UNARY_FUNCTIONS.add("cos");
                UNARY_FUNCTIONS.add("sqrt");
                UNARY_FUNCTIONS.add("square");
                UNARY_FUNCTIONS.add("cube");
                UNARY_FUNCTIONS.add("quart");
        }

...
public class GPFunctionMenuManager {
    ...
    public void printUsage(){
        ...
        System.err.println("java -jar gpfunction.jar -predictions path_to_data -model path_to_model -o path_to_predictions");
        System.err.println();
    ...
    //java -jar gpfunction.jar -predictions path_to_data -model path_to_model -o path_to_predictions
    public void parseGPFunctionPredictions(String args[]) throws IOException, ClassNotFoundException{
        String dataPath, predPath;
        String popPath;
        if (args.length==6){
            dataPath = args[1];
